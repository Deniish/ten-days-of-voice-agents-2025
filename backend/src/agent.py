...
# 👨‍⚕️ "Dr. Denish Store" - Auto-Lead Capture Agent
...
print("📚 SELLING: Dr. Denish's Cloud & AI Courses")
...
# Default FAQ data for "Dr. Denish Store"
DEFAULT_FAQ = [
    {
    ...
    },
    {
        ...
        "answer": "Yes! Dr. Denish releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Dr. Denish Store'.
            ...
            - Automatically call submit_lead_and_end when sufficient lead information is collected.
            - **Closing:** When the user is done, use `submit_lead_and_end`.
           
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Dr. Denish and email you." (Don't hallucinate prices).
            """,
