...
def seed_database():
    ...
    if cur.fetchone()[0] == 0:
        sample_data = [
            ...
            (
                "Michael", "55678", "3321",
                "Luxury Watches Co.", "$3,750.00", "1:12 AM CST", "luxurywatches.co",
                "pending_review", "Automated flag: Transaction outside normal spending pattern."
            ),
            (
                "Aisha", "78123", "8876",
                "Foreign Electronics Market", "$980.00", "3:45 AM GMT", "foreign-electro.net",
                "pending_review", "Automated flag: Cross-border transaction."
            ),
            (
                "Rahul", "66990", "5743",
                "Gaming Credit Top-up", "$1,250.00", "12:05 AM IST", "gamecredits.io",
                "pending_review", "Automated flag: Repeated rapid transactions."
            ),
            (
                "Emily", "44321", "9090",
                "Digital Gift Cards", "$2,450.00", "5:20 AM EST", "giftcardsplus.com",
                "pending_review", "Automated flag: Multiple high-value purchases."
            ),
            (
                "Karan", "88234", "6612",
                "Offshore Investment Portal", "$5,000.00", "2:55 AM IST", "invest-offshore.biz",
                "pending_review", "Automated flag: Suspicious merchant profile."
            ),
            (
                "Olivia", "30098", "7711",
                "Online Betting Platform", "$1,800.00", "11:40 PM PST", "betzone.live",
                "pending_review", "Automated flag: Risk category merchant."
            )
        ]
        cur.executemany(
            """
...
class FraudAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            You are 'Alex', a Fraud Detection Specialist at DeltaPro Bank.
