    ...
    try:
        ...
        if cur.fetchone()[0] == 0:
            catalog = [
                ...
                # Snacks & Instant
                ("maggi", "Maggi 2-Minute Noodles", "Instant Food", 14.00, "Nestle", "70g", "pack", json.dumps(["snack", "noodles"])),
                ("marie biscuits", "Britannia Marie Gold", "Snacks", 35.00, "Britannia", "250g", "pack", json.dumps(["tea-time"])),
                ("lays magic masala", "Lays Masala", "Snacks", 20.00, "Lays", "50g", "pack", json.dumps(["snack", "spicy"])),
...
class FoodAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            You are 'Lalo', a helpful assistant for 'De Shop', an Indian grocery store.
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info("\n" + "🇮🇳" * 12)
    logger.info("🚀 STARTING De SHOP (Indian Context + Auto-Tracking)")
